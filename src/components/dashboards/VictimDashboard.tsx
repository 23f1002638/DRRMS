...
export function VictimDashboard({ user, activeView, setActiveView, dataService }: VictimDashboardProps) {
  if (activeView === 'request') {
    return <AidRequestForm user={user} dataService={dataService} />;
  }
    ...
    return (
      <div className="p-6 space-y-6 max-w-4xl mx-auto">
        ...
        <div className="space-y-4">
          {dataService.aidRequests.map((request) => (
            <Card key={request.id}>
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <Badge variant={
                      request.urgency === 'critical' || request.urgency === 'high' ? 'destructive' :
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-3">
            {dataService.aidRequests.slice(0, 3).map((request) => (
